...
@dataclass
class PlotManager: 
      def manage_plots(self,Parameters,TransportHamiltonian):  
          if(Parameters.plot):               
      ...
      def plot_sparsity_maps(self,Parameters,TransportHamiltonian):
          logger('\n')
      ...
      def plot_conductance_and_spectral_function(self,Parameters,TransportHamiltonian):
          logger('\n')
          ...
          axs[1].plot(TransportHamiltonian.voltage/1.0e-3, TransportHamiltonian.current*Parameters.EVTOA/1.0e-9) # voltage in millivolts, current in nanoamperes
          axs[1].set_title(r'Current', loc='left')
          axs[1].set_xlabel(r'$V$ [mV]')
          axs[1].set_ylabel(r'$I$ [nA]')

          axs[2].plot(TransportHamiltonian.voltage/1.0e-3, TransportHamiltonian.conductance) # voltage in milivolts, conductance in 2e^2/h
          if(Parameters.spec):
             axs[2].plot(TransportHamiltonian.w/1.0e-3, TransportHamiltonian.transmission, '--')
          axs[2].set_title(r'Conductance', loc='left')
          axs[2].set_xlabel(r'$V$ [mV]')
          axs[2].set_ylabel(r'$dI/dV$ [$2e^2/h$]')
