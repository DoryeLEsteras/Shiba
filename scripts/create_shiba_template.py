...
if __name__ == '__main__':
   ...
   opened_file.write('dn_sub_file = sub_dn.in\n')
   opened_file.write('up_stm_file = stm_up.in\n')
   opened_file.write('dn_stm_file = stm_dn.in\n')
   opened_file.write('# noncolin_sub_file = sub_noncolin.in\n')
   opened_file.write('# noncolin_stm_file = stm_noncolin.in\n')
