...
if __name__ == '__main__':
   ...
   opened_file.write('#################################\n')
   opened_file.write('up_sub_file = sub_up.in\n')
   opened_file.write('down_sub_file = sub_down.in\n')
   opened_file.write('up_stm_file = stm_up.in\n')
   opened_file.write('down_stm_file = stm_down.in\n')
   opened_file.write('# comb_sub_file = sub_comb.in\n')
   opened_file.write('# comb_stm_file = stm_comb.in\n')
   opened_file.write('up_h = nbse2.up_hr.dat\n')
   opened_file.write('down_h = nbse2.down_hr.dat\n')
   opened_file.write('# comb_h = nbse2.up_hr.dat\n')
